...
class ChartTesting {
    ...
    startContainer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield exec.exec("sh", ["-c", "kubectl --namespace=kube-system create serviceaccount tiller --dry-run --output=yaml | kubectl apply -f -"]);
            yield exec.exec("sh", ["-c", "kubectl create clusterrolebinding tiller-cluster-rule --clusterrole=cluster-admin --serviceaccount=kube-system:tiller --dry-run --output=yaml | kubectl apply -f -"]);
            yield exec.exec("helm", ["init", "--service-account=tiller", "--upgrade", "--wait"]);
        });
    }
    killContainer() {
        return __awaiter(this, void 0, void 0, function* () {
            yield exec.exec("docker", ["kill", "ct"]);
        });
    }
    runInContainer(...args) {
        return __awaiter(this, void 0, void 0, function* () {
